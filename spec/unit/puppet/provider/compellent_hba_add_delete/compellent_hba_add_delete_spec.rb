...
describe Puppet::Type.type(:compellent_hba_add_delete).provider(:compellent_hba_add_delete) do
  ...
  before :each do
    ...
    Puppet::Type.type(:compellent_hba_add_delete).stubs(:defaultprovider).returns described_class
  end
  ...
  let :add_hba do
    Puppet::Type.type(:compellent_hba_add_delete).new(
